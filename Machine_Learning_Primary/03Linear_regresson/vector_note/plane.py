...
print 'first pair of planed are parallel?: {}'.format(p1.is_parallel_to(p2))
...
print 'second pair of planed are parallel?: {}'.format(p1.is_parallel_to(p2))
...
print 'third pair of planed are parallel?: {}'.format(p1.is_parallel_to(p2))
